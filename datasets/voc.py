...
class VOCSegmentation(data.Dataset):
    ...
    def __init__(self,
        ...
        image_dir = os.path.join(voc_root, 'Images')
        ...
        mask_dir = os.path.join(voc_root, 'ImagesPNG')
        ...
        i = 0
        if image_set == 'train':
            self.images = [os.path.join(image_dir, x + ".jpg") for x in file_names[:int(length)]]
            self.masks = [os.path.join(mask_dir, x + ".png") for x in file_names[:int(length)]]
        elif image_set == 'val':
            self.images = [os.path.join(image_dir, x + ".jpg") for x in file_names[int(length):]]
            self.masks = [os.path.join(mask_dir, x + ".png") for x in file_names[int(length):]]
...
# print(model)
# My = VOCSegmentation(root='D:\git\myself\datasets\data')
# model(p1)
# print(len(My))
# plt.imshow(My[1][1])
# plt.show()
